...
export default function DailyChecklist({ expanded = false, embedded = false }: { expanded?: boolean; embedded?: boolean }) {
    ...
    return (
        ...
        >
            ...
            <div className={[
                "flex gap-2 shrink-0",
                embedded ? "pb-4" : "border-b border-slate-800/40 px-4 py-2.5",
            ].join(" ")}>
                <input
            ...
            <div className={["flex-1 overflow-y-auto", embedded ? "px-0 py-0" : "px-4 py-3"].join(" ")}>
                {todayTasks.length === 0 && (
